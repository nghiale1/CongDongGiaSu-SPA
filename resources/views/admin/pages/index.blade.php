...
<div class="main-content">
    ...
    <div class="container-fluid content-top-gap">
        ...
        <div class="welcome-msg pt-3 pb-4">
            <h1>Hi <span class="text-primary">Nghĩa</span>, Welcome back</h1>
                                ...
                                <div class="inbox_people">
                                    ...
                                    <div class="inbox_chat">
                                        <div class="chat_list active_chat">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img
                                                        src="{{asset('admin/assets/images/avatar5.jpg')}}"
                                        ...
                                        <div class="chat_list">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img
                                                        src="{{asset('admin/assets/images/avatar3.jpg')}}"
                                        ...
                                        <div class="chat_list">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img
                                                        src="{{asset('admin/assets/images/avatar4.jpg')}}"
                                        ...
                                        <div class="chat_list">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img
                                                        src="{{asset('admin/assets/images/avatar2.jpg')}}"
                                        ...
                                        <div class="chat_list">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img
                                                        src="{{asset('admin/assets/images/avatar1.jpg')}}"
                                    ...
                                    <div class="msg_history">
                                        <div class="incoming_msg">
                                            <div class="incoming_msg_img"> <img
                                                    src="{{asset('admin/assets/images/avatar5.jpg')}}" alt="Alexander"
                                                    class="img-fluid"> </div>
