                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#" class="grid">
                                        <div class="user_img"><img src="{{asset('admin/assets/images/avatar1.jpg')}}"
                                                alt=""></div>
                                ...
                                <li class="odd"><a href="#" class="grid">
                                        <div class="user_img"><img src="{{asset('admin/assets/images/avatar2.jpg')}}"
                                                alt=""></div>
                                        <div class="notification_desc">
                                ...
                                <li><a href="#" class="grid">
                                        <div class="user_img"><img src="{{asset('admin/assets/images/avatar3.jpg')}}"
                                                alt=""></div>
                                        <div class="notification_desc">
                        ...
                        <li class="dropdown profile_details_drop">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3"
                                ...
                                <div class="profile_img">
                                    <img src="{{asset('Image/avatar.jpg')}}" class="rounded-circle" alt="" />
                            ...
                            <ul class="dropdown-menu drp-mnu" aria-labelledby="dropdownMenu3">
                                ...
                                <li class="logout"> <a href=""><i class="fa fa-power-off"></i> Logout</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
